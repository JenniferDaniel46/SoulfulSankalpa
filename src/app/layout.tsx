...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      ...
      <meta name="keywords" content="yoga, soulful sankalpa, soulful, sankalpa, cacao, sound healing, relaxation, purpose, sound bath, Jenn Daniel, yoga instructor, yoga in phoenix, yoga nidra, cacao ceremony, restorative yoga, vinyasa"/>
